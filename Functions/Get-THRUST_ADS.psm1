function Get-THRUST_ADS {
    ...
    .EXAMPLE 
        Get-THRUST_ADS -Path "C:\"
        Get-THRUST_ADS SomeHostName.domain.com -Path "C:\"
        Get-Content C:\hosts.csv | Get-THRUST_ADS -Path "C:\"
        Get-THRUST_ADS $env:computername -Path "C:\"
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_ADS -Path "C:\"
