function Get-THRUST_Hotfixes {
    ...
    .EXAMPLE 
        Get-THRUST_Hotfixes 
        Get-THRUST_Hotfixes SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Hotfixes
        Get-THRUST_Hotfixes $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Hotfixes
