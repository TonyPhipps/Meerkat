function Get-THRUST_Services {
    ...
    .EXAMPLE 
        Get-THRUST_Services 
        Get-THRUST_Services SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Services
        Get-THRUST_Services $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Services
