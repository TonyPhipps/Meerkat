function Get-THRUST_Strings {
    ...
    .EXAMPLE 
        Get-Content C:\hosts.csv | Get-THRUST_Strings -StringsPath c:\tools\sysinternals
        Get-THRUST_Strings $env:computername -StringsPath c:\tools\sysinternals
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Strings -StringsPath c:\tools\sysinternals
