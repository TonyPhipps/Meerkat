function Get-THRUST_ScheduledTasks {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_ScheduledTasks 
        Get-THRUST_ScheduledTasks SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_ScheduledTasks
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_ScheduledTasks
