function Get-THR_MRU {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-THR_MRU} | 
    ...
    begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-THR_MRU at {0}" -f $DateScanned)
