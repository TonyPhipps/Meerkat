function Get-THRUST_SCCM_Software {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_Software 
        Get-THRUST_SCCM_Software SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_Software
        Get-THRUST_SCCM_Software $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_Software
