function Get-THRUST_Hosts {
    ...
    .EXAMPLE 
        Get-THRUST_Hosts 
        Get-THRUST_Hosts  SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Hosts
        Get-THRUST_Hosts -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Hosts
