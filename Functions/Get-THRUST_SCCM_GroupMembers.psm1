function Get-THRUST_SCCM_GroupMembers {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_GroupMembers 
        Get-THRUST_SCCM_GroupMembers SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_GroupMembers
        Get-THRUST_SCCM_GroupMembers $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_GroupMembers
