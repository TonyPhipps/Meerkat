function Get-THRUST_Shares {
    ...
    .EXAMPLE 
        Get-THRUST_Shares 
        Get-THRUST_Shares SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Shares
        Get-THRUST_Shares $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Shares
