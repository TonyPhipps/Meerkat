function Get-THRUST_SCCM_Computer {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_Computer 
        Get-THRUST_SCCM_Computer SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_Computer
        Get-THRUST_SCCM_Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_Computer
