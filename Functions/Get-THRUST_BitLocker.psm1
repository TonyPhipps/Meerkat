function Get-THRUST_BitLocker {
    ...
    .EXAMPLE 
        Get-THRUST_BitLocker
        '<COMPUTERNAME>','<COMPUTERNAME>','<COMPUTERNAME>' | Get-THRUST_BitLocker 
        Get-THRUST_BitLocker SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_BitLocker
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_BitLocker
