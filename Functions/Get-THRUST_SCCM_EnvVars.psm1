function Get-THRUST_SCCM_EnvVars {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_EnvVars 
        Get-THRUST_SCCM_EnvVars SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_EnvVars
        Get-THRUST_SCCM_EnvVars $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_EnvVars
