Function Get-THRUST_Computer {
    ...
    .EXAMPLE
        Get-THRUST_Computer 
        Get-THRUST_Computer SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Computer
        Get-THRUST_Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Computer
