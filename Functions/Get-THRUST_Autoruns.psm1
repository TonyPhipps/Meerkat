function Get-THRUST_Autoruns {
    ...
    .EXAMPLE 
        Get-THRUST_Autoruns 
        Get-THRUST_Autoruns SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Autoruns
        Get-THRUST_Autoruns -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Autoruns
