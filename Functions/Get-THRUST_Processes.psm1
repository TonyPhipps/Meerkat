Function Get-THRUST_Processes {
    ...
    .EXAMPLE 
        Get-THRUST_Processes 
        Get-THRUST_Processes SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Processes
        Get-THRUST_Processes $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Processes
