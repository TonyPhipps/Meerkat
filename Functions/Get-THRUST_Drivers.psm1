function Get-THRUST_Drivers {
    ...
    .EXAMPLE 
        Get-THRUST_Drivers 
        Get-THRUST_Drivers SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Drivers
        Get-THRUST_Drivers -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Drivers
