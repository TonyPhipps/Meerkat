function Get-THR_Software {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-THR_Software} | 
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-THR_Software at {0}" -f $DateScanned)
