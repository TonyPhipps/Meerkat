function Get-THRUST_DLLs {
    ...
    .EXAMPLE 
        Get-THRUST_DLLs 
        Get-THRUST_DLLs SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_DLLs
        Get-THRUST_DLLs $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_DLLs
