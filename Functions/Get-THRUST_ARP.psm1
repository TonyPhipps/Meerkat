function Get-THRUST_ARP {
    ...
    .EXAMPLE 
        Get-THRUST_ARP 
        Get-THRUST_ARP  SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_ARP
        Get-THRUST_ARP -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_ARP
