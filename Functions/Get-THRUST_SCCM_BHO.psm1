function Get-THRUST_SCCM_BHO {
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_BHO 
        Get-THRUST_SCCM_BHO SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_BHO
        Get-THRUST_SCCM_BHO $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_BHO
