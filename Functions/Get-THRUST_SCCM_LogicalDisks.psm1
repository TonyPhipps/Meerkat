function Get-THRUST_SCCM_LogicalDisks {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_LogicalDisks 
        Get-THRUST_SCCM_LogicalDisks SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_LogicalDisks
        Get-THRUST_SCCM_LogicalDisks $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_LogicalDisks
