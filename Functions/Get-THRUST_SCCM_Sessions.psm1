function Get-THRUST_SCCM_Sessions {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_Sessions 
        Get-THRUST_SCCM_Sessions SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_Sessions
        Get-THRUST_SCCM_Sessions $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_Sessions
