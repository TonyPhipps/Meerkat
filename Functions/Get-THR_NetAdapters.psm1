function Get-THR_NetAdapters {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-THR_NetAdapters} | 
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-THR_NetAdapters at {0}" -f $DateScanned)
