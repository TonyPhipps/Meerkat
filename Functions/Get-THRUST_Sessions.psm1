function Get-THRUST_Sessions {
    ...
    .EXAMPLE 
        Get-THRUST_Sessions 
        Get-THRUST_Sessions SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Sessions
        Get-THRUST_Sessions -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Sessions
