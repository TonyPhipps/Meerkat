function Get-THRUST_Ports {
    ...
    .EXAMPLE
        Get-THRUST_Ports 
        Get-THRUST_Ports SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Ports
        Get-THRUST_Ports -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Ports
