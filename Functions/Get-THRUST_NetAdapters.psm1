function Get-THRUST_NetAdapters {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_NetAdapters 
        Get-THRUST_NetAdapters SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_NetAdapters
        Get-THRUST_NetAdapters -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_NetAdapters
