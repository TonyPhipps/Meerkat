function Get-THR_GroupMembers {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-THR_GroupMembers} | 
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-THR_GroupMembers at {0}" -f $DateScanned)
