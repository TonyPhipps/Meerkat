 function Get-THRUST_Hardware {
    ...
    .EXAMPLE 
        Get-THRUST_Hardware 
        Get-THRUST_Hardware SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_Hardware
        Get-THRUST_Hardware -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_Hardware
