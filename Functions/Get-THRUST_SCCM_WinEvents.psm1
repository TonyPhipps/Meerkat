function Get-THRUST_SCCM_WinEvents {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_WinEvents 
        Get-THRUST_SCCM_WinEvents SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_WinEvents
        Get-THRUST_SCCM_WinEvents $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_WinEvents
