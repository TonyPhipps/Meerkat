function Get-THRUST_SCCM_Services {
    <#
    .SYNOPSIS 
    ...
    .EXAMPLE 
        Get-THRUST_SCCM_Services 
        Get-THRUST_SCCM_Services SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_SCCM_Services
        Get-THRUST_SCCM_Services $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_SCCM_Services
