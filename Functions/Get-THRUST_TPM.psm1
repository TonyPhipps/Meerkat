function Get-THRUST_TPM {
    ...
    .EXAMPLE 
        Get-THRUST_TPM 
        Get-THRUST_TPM SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_TPM
        Get-THRUST_TPM $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_TPM
