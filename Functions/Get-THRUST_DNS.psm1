function Get-THRUST_DNS {
    ...
    .EXAMPLE 
        Get-THRUST_DNS 
        Get-THRUST_DNS SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_DNS
        Get-THRUST_DNS -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_DNS
