function Get-THRUST_RecycleBin {
    <#
    .SYNOPSIS 
        ...
    ...
    .EXAMPLE 
        Get-THRUST_RecycleBin 
        Get-THRUST_RecycleBin SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-THRUST_RecycleBin
        Get-THRUST_RecycleBin -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-THRUST_RecycleBin
