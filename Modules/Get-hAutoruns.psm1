function Get-hAutoruns {
    ...
    .EXAMPLE 
        Get-hAutoruns SomeHostName.domain.com
        Get-Content C:\hosts.csv | Get-hAutoruns
        Get-hAutoruns -Computer $env:computername
        Get-ADComputer -filter * | Select -ExpandProperty Name | Get-hAutoruns
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hAutoruns at {0}" -f $DateScanned)
