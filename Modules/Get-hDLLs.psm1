function Get-hDLLs {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hDLLs} | 
    ...
    .LINK
       ...
       https://github.com/TonyPhipps/HAMER/wiki/DLLs
    #>
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hDLLs at {0}" -f $DateScanned)
