function Get-hBitLocker {
    ...
    .EXAMPLE
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hBitLocker} | 
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hBitLocker at {0}" -f $DateScanned)
