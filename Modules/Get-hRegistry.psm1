function Get-hRegistry {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hRegistry} | 
    ...
    .LINK
       ...
       https://github.com/TonyPhipps/HAMER/wiki/Registry
    ...
    begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hRegistry at {0}" -f $DateScanned)
