function Get-hCertificates {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hCertificates} | 
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hCertificates at {0}" -f $DateScanned)
