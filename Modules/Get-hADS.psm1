function Get-hADS {
    ...
    .EXAMPLE 
        Get-hADS -Path "C:\Temp"
        
    .EXAMPLE
        $Targets = Get-ADComputer -filter * | Select -ExpandProperty Name
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hADS} -ArgumentList "C:\Temp" | 
    ...
    begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hADS at {0}" -f $DateScanned)
