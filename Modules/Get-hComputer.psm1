Function Get-hComputer {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hComputer} | 
    ...
    .LINK
       ...
       https://github.com/TonyPhipps/HAMER/wiki/Computer
    ...
    begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hComputer at {0}" -f $DateScanned)
