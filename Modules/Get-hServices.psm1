function Get-hServices {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hServices} | 
    ...
    .LINK
        ...
        https://github.com/TonyPhipps/HAMER/wiki/Services
    #>
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hServices at {0}" -f $DateScanned)
