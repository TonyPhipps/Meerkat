function Get-hTCPConnections {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hTCPConnections} | 
    ...
    .LINK
        ...
        https://github.com/TonyPhipps/HAMER/wiki/TCPConnections
    #>
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hTCPConnections at {0}" -f $DateScanned)
