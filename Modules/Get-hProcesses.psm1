function Get-hProcesses {
    ...
    .EXAMPLE
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hProcesses} | 
    ...
    .LINK
       ...
       https://github.com/TonyPhipps/HAMER/wiki/Processes
    #>
    ...
    begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hProcesses at {0}" -f $DateScanned)
