function Get-hDrivers {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hDrivers} | 
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hDrivers at {0}" -f $DateScanned)
