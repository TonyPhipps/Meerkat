function Get-hGroupMembers {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hGroupMembers} | 
    ...
    .LINK
       ...
       https://github.com/TonyPhipps/HAMER/wiki/GroupMembers
    #>
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hGroupMembers at {0}" -f $DateScanned)
