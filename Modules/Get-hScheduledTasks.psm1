function Get-hScheduledTasks {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hScheduledTasks} | 
    ...
    .LINK
       ...
       https://github.com/TonyPhipps/HAMER/wiki/ScheduledTasks
    #>
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hScheduledTasks at {0}" -f $DateScanned)
