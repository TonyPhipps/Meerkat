function Get-hEventLogs {
    ...
    .EXAMPLE 
        ...
        ForEach ($Target in $Targets) {
            Invoke-Command -ComputerName $Target -ScriptBlock ${Function:Get-hEventLogs} | 
    ...
    .LINK
       ...
       https://github.com/TonyPhipps/HAMER/wiki/EventLogs
    #>
	...
	begin{
        ...
        Write-Information -InformationAction Continue -MessageData ("Started Get-hEventLogs at {0}" -f $DateScanned)
